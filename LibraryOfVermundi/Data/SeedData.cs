    ...
    public static void Seed(AppDbContext ctx)
    {
        if (!ctx.Entries.Any())
        {
            ...
            AppUser contributor1 = new AppUser
            {
                AppUserId = 1,
                UserName = "vratha",
                SignUpDate = DateTime.Parse("07/26/2013")
            };
            ...
            AppUser contributor2 = new AppUser
            {
                AppUserId = 2,
                UserName = "damian",
                SignUpDate = DateTime.Parse("07-30-2013")
            };
            ...
            AppUser contributor3 = new AppUser
            {
                AppUserId = 3,
                UserName = "alkandrana",
                SignUpDate = DateTime.Parse("12-25-2013")
            };
            ...
            Entry magic = new Entry
            {
                ...
                SubmissionDate = DateTime.Parse("08-01-2013"),
                Category = catM,
                CategoryId = "M"
            };
            ...
            Entry ustores = new Entry
            {
                ...
                Title = "On Ustores",
                Contributor = contributor1,
                SubmissionDate = DateTime.Parse("08-15-2013"),
                Category = catL,
                CategoryId = "L"
            };
            ...
            Entry dynast1 = new Entry
            {
                ...
                SubmissionDate = DateTime.Parse("10-16-2013"),
                Category = catB,
                CategoryId = "B"
            };
            ...
            Entry dynast2 = new Entry
            {
                ...
                SubmissionDate = DateTime.Parse("12-25-2013"),
                Category = catB,
                CategoryId = "B"
            };
